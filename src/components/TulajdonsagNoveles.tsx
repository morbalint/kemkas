...
import {KarakterTulajdonsagok, Tulajdonsag, TulajdonsagIDs, TulajdonsagLabel} from "../domain-models/tulajdonsag";
        ...
        <div className='row'>
            ...
            <div className='col-lg-6'>
                <div className='row m-2'>
                    ...
                    <span className='col col-form-label'>{tulajdonsagok[tulajdonsagNoveles]}</span>
                </div>
            </div>
        </div>
    </>
