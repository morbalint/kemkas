...
export function OsztalyDescription(osztaly: Osztaly) : string {
    switch (osztaly) {
        ...
        case Osztaly.Ijasz:
        case Osztaly.Kaloz:
            return 'A harcosok a fegyverhasználat mesterei. Megállják a helyüket a közelharcban és a távolsági összecsapásokban is, s sokkal jobban viselik a sebesüléseket, mint más osztályok képviselői. Ez az osztály mind közül a leggyakoribb, de egyben a legváltozatosabb is – öt alosztállyal rendelkezik. A játék elején minden harcos választhat egy tetszőleges harci stílust.';
        case Osztaly.Tolvaj:
