...
public interface ICharacterPersistenceService
{
    ...
    public Task<V1Karakter?> GetCharacterById(Guid id, bool tracking = false);

    public Task<List<CharacterListItemDto>> GetAllCharactersOfUser();
    
    public Task UpdateCharacter(V1Karakter karakter, bool isPublic = false);
}
    ...
    ) : ICharacterPersistenceService
{
    ...
    public async Task<V1Karakter?> GetCharacterById(Guid id, bool tracking = false)
    {
    ...
    public async Task UpdateCharacter(V1Karakter karakter, bool isPublic = false)
    {
        karakter.IsPublic = isPublic;
